		...
		<section
			...
			<div className='flex flex-1 flex-col gap-4 md:gap-5'>
				...
				<span className='flex flex-col gap-3 text-sm font-light leading-loose text-secondary lg:gap-5 lg:text-base'>
					...
					<p className='leading-loose'>
						برگزاری پایگاه های تابستانی، تشکیل گروه رزمی نوجوانان در رشته کاراته
						(کیوکوشین) و کسب مقام نائب قهرمانی کشور ، تشکیل گروه سرود و انجام اولین
						اجراهای پاتوقی در بوستان‌ها و میادین شهر تهران، تولید بیش از ده سرود و
						نماهنگ انقلابی و آئینی، همکاری با نهادهای مردمی، انقلابی و هیئات مذهبی در
						مبحث تولید محتوا
					</p>
				</span>
